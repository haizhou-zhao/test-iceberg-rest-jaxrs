...
@JsonTypeName("RemoveSnapshotRefUpdate")
...
public class RemoveSnapshotRefUpdate   {
  ...
  /**
   **/
  public RemoveSnapshotRefUpdate action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  /**
   **/
  public RemoveSnapshotRefUpdate refName(String refName) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveSnapshotRefUpdate removeSnapshotRefUpdate = (RemoveSnapshotRefUpdate) o;
    return Objects.equals(this.action, removeSnapshotRefUpdate.action) &&
        Objects.equals(this.refName, removeSnapshotRefUpdate.refName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, refName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveSnapshotRefUpdate {\n");
