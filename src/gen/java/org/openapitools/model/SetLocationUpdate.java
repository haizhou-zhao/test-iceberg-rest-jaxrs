...
@JsonTypeName("SetLocationUpdate")
...
public class SetLocationUpdate   {
  ...
  /**
   **/
  public SetLocationUpdate action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  /**
   **/
  public SetLocationUpdate location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    SetLocationUpdate setLocationUpdate = (SetLocationUpdate) o;
    return Objects.equals(this.action, setLocationUpdate.action) &&
        Objects.equals(this.location, setLocationUpdate.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLocationUpdate {\n");
