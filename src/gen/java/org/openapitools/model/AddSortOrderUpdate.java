...
@JsonTypeName("AddSortOrderUpdate")
...
public class AddSortOrderUpdate   {
  ...
  /**
   **/
  public AddSortOrderUpdate action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  /**
   **/
  public AddSortOrderUpdate sortOrder(SortOrder sortOrder) {
  ...
  public boolean equals(Object o) {
    ...
    AddSortOrderUpdate addSortOrderUpdate = (AddSortOrderUpdate) o;
    return Objects.equals(this.action, addSortOrderUpdate.action) &&
        Objects.equals(this.sortOrder, addSortOrderUpdate.sortOrder);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, sortOrder);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSortOrderUpdate {\n");
