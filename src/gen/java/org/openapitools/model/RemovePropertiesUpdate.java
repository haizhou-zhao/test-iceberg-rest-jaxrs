...
@JsonTypeName("RemovePropertiesUpdate")
...
public class RemovePropertiesUpdate   {
  ...
  /**
   **/
  public RemovePropertiesUpdate action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  /**
   **/
  public RemovePropertiesUpdate removals(List<String> removals) {
  ...
  public RemovePropertiesUpdate addRemovalsItem(String removalsItem) {
  ...
  public RemovePropertiesUpdate removeRemovalsItem(String removalsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RemovePropertiesUpdate removePropertiesUpdate = (RemovePropertiesUpdate) o;
    return Objects.equals(this.action, removePropertiesUpdate.action) &&
        Objects.equals(this.removals, removePropertiesUpdate.removals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, removals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemovePropertiesUpdate {\n");
