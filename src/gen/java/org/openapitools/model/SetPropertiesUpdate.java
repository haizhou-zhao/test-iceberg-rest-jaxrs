...
@JsonTypeName("SetPropertiesUpdate")
...
public class SetPropertiesUpdate   {
  ...
  /**
   **/
  public SetPropertiesUpdate action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  /**
   **/
  public SetPropertiesUpdate updates(Map<String, String> updates) {
  ...
  public SetPropertiesUpdate putUpdatesItem(String key, String updatesItem) {
  ...
  public SetPropertiesUpdate removeUpdatesItem(String updatesItem) {
  ...
  public boolean equals(Object o) {
    ...
    SetPropertiesUpdate setPropertiesUpdate = (SetPropertiesUpdate) o;
    return Objects.equals(this.action, setPropertiesUpdate.action) &&
        Objects.equals(this.updates, setPropertiesUpdate.updates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, updates);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetPropertiesUpdate {\n");
